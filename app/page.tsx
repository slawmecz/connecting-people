...
export default function Home() {
  ...
  return (
    <div>
      ...
      <section className="flex flex-col justify-center items-center px-4 text-center gap-6 relative overflow-hidden min-h-screen md:h-[115vh]" style={{minHeight: '100dvh'}}>
      {/* Marble background */}
      ...
      <div className="absolute bottom-40 left-1/4 animate-pulse opacity-70">
        <div className="w-4 h-4 bg-[#72569c] transform rotate-45"></div>
      </div>
      <div className="absolute bottom-40 right-1/4 animate-pulse opacity-70" style={{animationDelay: '1s'}}>
        <div className="w-4 h-4 bg-[#72569c] transform rotate-45"></div>
      </div>
      <a href="#jak-dzialamy" className="absolute bottom-28 left-1/2 transform -translate-x-1/2 cursor-pointer opacity-80 hover:opacity-100 transition-all duration-300 hover:scale-110 animate-bounce-gentle group z-50" style={{animationDelay: '1s'}}>
